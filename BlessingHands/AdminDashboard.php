...
<body><br><br>
    ...
    <div class="container">
        <div class="btn-group-custom my-5">
            ...
            <button class="btn btn-primary btn-custom"><a href="http://localhost/phpmyadmin/index.php?route=/sql&pos=0&db=lecture_panel_db&table=registrations" class="text-light">Manage Student of Courses</a></button>
            <button class="btn btn-primary btn-custom"><a href="http://localhost/phpmyadmin/index.php?route=/sql&pos=0&db=lecture_panel_db&table=caregivers" class="text-light">Manage Caregiver</a></button>
            ...
            <button class="btn btn-primary btn-custom"><a href="https://docs.google.com/spreadsheets/d/1lQJ1_jkM-SZ8p_yj4Kdyg865ZaHCTkMf-TcznUfawQU/edit?gid=0#gid=0" class="text-light">Manage Feedback</a></button>
        
           <button class="btn btn-success btn-custom"><a href="home.php" class="text-light">View   Site</a></button>
        </div>
        <button class="btn btn-secondary btn-custom"><a href="http://localhost/phpmyadmin/index.php?route=/sql&pos=0&db=lecture_panel_db&table=courses" class="text-light">Manage Courses</a></button>
        <button class="btn btn-secondary btn-custom"><a href="http://localhost/phpmyadmin/index.php?route=/sql&pos=0&db=lecture_panel_db&table=lecturers" class="text-light">Manage Lectures</a></button>

<br>
       <br> <button class="btn btn-secondary btn-custom"><a href="Register.php" class="text-light">Add User</a></button>
